...
| **Unidad comercial** | **«Conversaciones»** = **un bloque de hasta 25 respuestas del asistente** a un mismo cliente en 24 h continuas; la respuesta 26 del mismo día cuenta otra, y a las 24 h la cuenta vuelve a cero (decidido 2026-09-13, `NovuChat/Analisis/27`). Definida en `/precios` y en `/terminos` | doc 02 §5 |
...
| **Planes** (presentación 8, 2026-09-11) | Impulso **USD 25 / 100** conv. · Crecimiento **USD 50 / 220** · Pro **USD 90 / 500**, **prepago mensual**. Instalación **USD 65**, pago único **por adelantado al inicio del servicio**, llave en mano (a medida desde **USD 125**); **sin bonificación**: la de la Rueda de Negocios terminó. Excedente **USD 10 por hasta 30** conversaciones, y no vence | doc 02 §5 |
